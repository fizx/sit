...
#ifndef YY_QP_QUERY_PARSER_H_INCLUDED
# define YY_QP_QUERY_PARSER_H_INCLUDED
/* Enabling traces.  */
#ifndef QPDEBUG
# if defined YYDEBUG
#  if YYDEBUG
...
#endif /* !YY_QP_QUERY_PARSER_H_INCLUDED  */
